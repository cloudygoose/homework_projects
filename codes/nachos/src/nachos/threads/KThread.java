...
public class KThread {
	...
	public static void finish() {
		...
		//Lib.hdebug(currentThread.getName()+"finish");
	...
	protected void restoreState() {
		...
		//tell something to the AUTOGRADER
	...
	private static class PingTest implements Runnable {
		...
		public void run() {
			//Lib.hdebug("Now Thread : " + which + " current Thread is : " + KThread.currentThread().getName());
			...
			//Lib.hdebug(which + "increase complete");
			for (int i = 0; i < 5; i++) {
				//Lib.hdebug("time : "  + Machine.timer().getTime());
	...
	public static void selfTest() {
		//Lib.hdebug("Kthread.selfTest begin");
		//Lib.debug(dbgThread, "Enter KThread.selfTest");

		new KThread(new PingTest(0)).setName("forked thread 0").fork();
	...
	public ThreadQueue joinQueue = ThreadedKernel.scheduler.newThreadQueue(true);
}
